...
Каждая операция даёт конкретный результат, а не «ещё одну заметку»:
- **Scout:** приношу шортлист крутых источников под твой профиль; ты выбираешь, что изучать.
...
- **Digest:** на старте сессии сам показываю, что двигает цель сейчас + 1 шаг; поднимаю забытое.
