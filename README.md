...
Один мозг знает, что я **думаю** (эта база знаний). Второй — агент-коуч [`health-harness`](https://github.com/) — знает, что со мной **происходит**: сон, восстановление (Whoop), настроение, решения. По отдельности каждый слеп на половину картины. Соединённые — делают то, что ни один не может в одиночку.
